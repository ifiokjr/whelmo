...
export default (variables = variable) => {
  ...
  const headerTheme = {
    ...
    '.rounded': {
      'NativeBase.Item': {
        borderRadius: isIOS && platformStyle !== 'material' ? 25 : 3,
      },
    },
    'NativeBase.Left': {
      'NativeBase.Button': {
      ...
      flex: isIOS && platformStyle !== 'material' ? 1 : 0.5,
      alignSelf: 'center',
      alignItems: 'flex-start',
    },
    'NativeBase.Body': {
      flex: 1,
      alignItems:
        isIOS && platformStyle !== 'material' ? 'center' : 'flex-start',
      alignSelf: 'center',
      'NativeBase.Segment': {
        borderWidth: 0,
        alignSelf: 'flex-end',
